...
- [looqme](https://ru.looqme.io/) - сервіс для моніторингу соціальних мереж та аналізу онлайн-репутації, надає продукти та рішення для вимірювання та аналізу ефективності маркетингових кампаній, відстеження онлайн-репутації та настроїв користувачів, моніторингу конкурентів та інших завдань.
